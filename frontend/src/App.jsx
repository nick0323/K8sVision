...
import './App.css';
import { FaLayerGroup, FaDesktop, FaBell, FaCubes, FaTasks, FaChartPie, FaDatabase, FaShieldAlt, FaProjectDiagram, FaSync, FaNetworkWired, FaRegClock, FaChevronDown, FaChevronRight, FaHdd, FaBoxOpen, FaBoxes, FaCog, FaKey } from 'react-icons/fa';
    ...
    <div className="layout-root">
      <div className="sider-menu">
        <div className="logo-area">
          <span style={{fontSize: 'var(--font-size-2xl)', fontWeight: 700, color: '#2563eb', letterSpacing: '1px'}}>KubeVision</span>
        </div>
